...
const translations = {
    en: {
        ...
        'Joules per Terahash, the lower the better': 'Joules per Terahash, the lower the better',

        'Tariff': 'Enter your local tariff',
        'tariff-helper': 'The value above is the estimated tariff in Rio de Janeiro',
        ...
        'Select miner to set values': 'Select a miner to automatically set the values bellow or tap fields to enter your custom values manually',
        
        'Modal help title': 'Help + Info',
        'Modal help Button': 'Help + Info',
        'Modal help 00': 'Choose the language: EN | PT\nNote that in English the cost is calculated in dollars and in Portuguese in Brazilian Reais.',
        'Modal help 01': 'Select a miner to automatically set Hashrate, Power, and Efficiency values. You can also tap the fields to enter your values manually.',
        'Modal help 02': 'My miner values are approximated.\nCheck the manufacturer\'s specifications for more precise values.',
        'Modal help 03': 'Efficiency = Power ÷ Hashrate\n J/TH = Watts ÷ TH/s\nLower J/TH values = more efficiency',
        'Modal help 04': 'Check your electricity bill to find out your local tariff, including taxes.',
        'Modal help 05': 'Results are calculated based on 732 hours of monthly operation (annual average).'
    },
    pt: {
        ...
        'Joules per Terahash, the lower the better': 'Joules por Terahash, o menor é o melhor',
        ...
        'disclaimer-02': 'Fórmula da Eficiência: Joules/Terahash (J/TH) = Watts/TH/s',
        'disclaimer-03': 'Confira especificações do fabricante para valores precisos.',

        'Select miner': 'Selecione um minerador ou insira valores',
        'Miners': 'Mineradores',
        'Custom values': 'Valores personalizados',
        'Select miner to set values': 'Selecione um minerador para definir os valores abaixo ou toque nos campos para inserir seus valores',
        
        'Modal help title': 'Como usar + informações',
        'Modal help Button': 'Como usar e mais informações',
        'Modal help 00': 'Escolha o idiona: EN | PT\nNote que em inglês o custo é calculado em dólares e em português em reais.',
        'Modal help 01': 'Selecione um minerador para definir automaticamente os valores de Hashrate, Potência e Eficiência. Você também pode tocar nos campos para inserir seus valores manualmente.',
        'Modal help 02': 'Meus valores são aproximados.\nConfira as especificações do fabricante para valores mais precisos.',
        'Modal help 03': 'Eficiência = Potência ÷ Hashrate\n J/TH = Watts ÷ TH/s\nValores J/TH mais baixos = maior eficiência',
        'Modal help 04': 'Confira sua conta de luz para descobrir quanto é a sua tarifa local com impostos.',
        'Modal help 05': 'Os resultados são calculados com base em 732 horas de operação mensal (média anual).'
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('btnPT').addEventListener('click', () => translatePage('pt'));
